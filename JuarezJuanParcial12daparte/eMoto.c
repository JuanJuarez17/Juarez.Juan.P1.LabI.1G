...
int altaMoto(eMoto vec[], int tam, eTipo vecTipo[], int tamTipo, eColor vecColor[], int tamColor, int* pNextId){
    ...
    if(vec && pNextId && tam > 0){ //(vec != NULL && pNextId != NULL && tam > 0)
        ...
        if(indice == -1){
            ...
            printf("\nIngrese el ID del tipo de moto: ");
            fflush(stdin);
            scanf("%d", &idTipo);

            while(!validarTipo(vecTipo, tamTipo, idTipo)){
                printf("Error! Ingrese el ID del tipo de moto: ");
                fflush(stdin);
                scanf("%d", &idTipo);
            }
            ...
            printf("\nIngrese el ID del color de la moto: ");
            fflush(stdin);
            scanf("%d", &idColor);
...
int ordenarMotoTipoId(eMoto vec[], int tam, int criterio){
    int rtn = 0;
    eMoto aux;
    if(vec != NULL && tam > 0){
        for(int i = 0; i < tam; i++){
...
int hardcodearMotos(eMoto vec[], int tam, int cant, int* pNextId){ // cant: Cantidad de pasajeros que quiero cargar a pesar de que el array sea de 10
    ...
    eMoto moto[10] = {
        ...
        {0, "Honda", 1020, 10010, 600, 7, 0},
        {0, "Benelli", 1010, 10040, 50, 10, 0},
        {0, "Motomel", 1020, 10020, 125, 3, 0},
        {0, "Honda", 1010, 10030, 750, 5, 0},
        {0, "Yamaha", 1030, 10040, 125, 2, 0},
        {0, "Suzuki", 1020, 10030, 750, 2, 0},
        {0, "Motomel", 1030, 10030, 50, 4, 0},
        {0, "Yamaha", 1030, 10010, 125, 1, 0},
    };
...
int hardcodearMotos2(eMoto vec[], int tam, int cant, int* pNextId){ // cant: Cantidad de pasajeros que quiero cargar a pesar de que el array sea de 10
    int rtn = 0;
    eMoto moto[5] = {
        {0, "Yamaha", 1000, 10040, 125, 9, 0},
        {0, "Benelli", 1010, 10010, 500, 1, 0},
        {0, "Honda", 1020, 10020, 600, 7, 0},
        {0, "Suzuki", 1010, 10030, 50, 10, 0},
        {0, "Motomel", 1030, 10030, 125, 3, 0},
    };
    if(vec != NULL && pNextId != NULL && tam > 0 && tam <= 100 && cant <= tam){
        for(int i = 0; i < cant; i++){
            vec[i] = moto[i];
...
int cargarDescripcionMoto(eMoto vec[], int tam, int id, char desc[]){
    int rtn = 0;
